...
/// One supported timestamp format. The variants match VERIFY
...
pub fn parse_input_file(body: &str) -> Result<Vec<(i64, Option<String>)>, VerifyError> {
    let mut out = Vec::new();
...
/// Used by both this module and `apps/verify-cli/src/main.rs`'s
