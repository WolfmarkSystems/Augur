...
//!
//! ```sh
//! AUGUR_RUN_INTEGRATION_TESTS=1 cargo test -p augur-stt \
//!     --test whisper_integration -- --include-ignored
//! ```

use std::path::PathBuf;
use augur_stt::{ModelManager, SttEngine, WhisperPreset};
...
#[test]
#[ignore = "requires AUGUR_RUN_INTEGRATION_TESTS=1 and network access on first run"]
...
#[test]
#[ignore = "Sprint 2: requires AUGUR_RUN_INTEGRATION_TESTS=1, model download, and a fixture WAV"]
