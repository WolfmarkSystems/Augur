//! `augur benchmark` — performance-regression tracking.
//!
...
pub fn run_suite(options: &BenchmarkOptions) -> Result<BenchmarkSuite, AugurError> {
...
fn run_full_translation_bench(fixtures: &Path) -> Result<BenchmarkResult, AugurError> {
...
pub fn render_text(suite: &BenchmarkSuite) -> String {
    ...
    out.push_str(&format!(
        "Generated: {}\nHost: {}\nVerify: {}\n\n",
        suite.generated_at, suite.host, suite.augur_version
    ));
    out.push_str(&format!(
        "{:<40} {:>9} {:>10} {:>10} {:>14}\n",
...
mod tests {
    ...
    fn fixtures_dir() -> PathBuf {
        ...
        // Walk up two levels from CARGO_MANIFEST_DIR (apps/augur-cli/).
